...
# 6.1 Pilot AI Companion (Brand Differentiator)

## Vision

PerkPilot is more than a financial app—it includes an intelligent AI companion named **Pilot**.
...
Pilot becomes the primary interface for interacting with PerkPilot.
...
The visual identity should match PerkPilot's premium midnight-blue design language and convey trust, intelligence, and guidance.
